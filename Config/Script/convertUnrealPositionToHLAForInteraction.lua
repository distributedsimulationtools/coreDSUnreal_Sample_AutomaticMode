...
DSimLocal.X, DSimLocal.Y, DSimLocal.Z = EnuToEcef(DSimLocal.X/100, DSimLocal.Y/100, DSimLocal.Z/100, referenceOffset_Lat , referenceOffset_Long , referenceOffset_Alt )
